...
const URL = "https://deezerdevs-deezer.p.rapidapi.com/playlist/" + idPlaylist;
...
window.addEventListener("DOMContentLoaded", () => {
  fetch(URL, {
    ...
    .then((playlist) => {
      ...
      //inserisco dati della playlist dinamicamente nel banner in alto

      const coverAlbum = document.getElementById("coverAlbum");
      coverAlbum.src = playlist.picture_medium;
      ...
      playlist.tracks.data.forEach((song) => {
        ...
        nomeCanzone.addEventListener("click", () => {
          const imgPlayer = document.getElementById("album-art");
          imgPlayer.src = song.cover_small;
